-- $Id: //depot/Projects/StarWars/Run/Data/Scripts/Library/PGCommands.lua#65 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars/Run/Data/Scripts/Library/PGCommands.lua $
--
...
function Register_Prox(obj, func, range, player_filter)
	...
	if not TestValid(obj) then
		MessageBox("%s -- Error, object doesn't exist; aborting", tostring(Script))
		return
	end
