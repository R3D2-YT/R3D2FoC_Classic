-- $Id: //depot/Projects/StarWars/Run/Data/Scripts/AI/LandMode/BobaFettFlameInfantry.lua#10 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars/Run/Data/Scripts/AI/LandMode/BobaFettFlameInfantry.lua $
--
--    Original Author: James Yarrow
--
--            $Author: michael_fetterman $
--
--            $Change: 35516 $
--
--          $DateTime: 2005/12/17 16:39:20 $
--
--          $Revision: #10 $
--
--/////////////////////////////////////////////////////////////////////////////////////////////////
...
function MoveUntilDone(target, max_duration)
	...
	while TestValid(target) and fett.Get_Distance(target) > 30 and (block.IsFinished() ~= true) do
...
function MainForce_Unit_Damaged(tf, unit, attacker, deliberate)
	...
	if unit.Get_Time_Till_Dead() < 30 then
	
		-- Move to a safe location
		hide_target = Find_Nearest(fett, "HealsInfantry", PlayerObject, true)
		...
		if hide_target then
			if unit.Is_Ability_Ready("JET_PACK") then
				unit.Activate_Ability("JET_PACK", hide_target)
			else
