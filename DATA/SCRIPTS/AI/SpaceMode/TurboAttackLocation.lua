-- $Id: //depot/Projects/StarWars/Run/Data/Scripts/AI/SpaceMode/TurboAttackLocation.lua#9 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars/Run/Data/Scripts/AI/SpaceMode/TurboAttackLocation.lua $
--
...
function MainForce_Thread()
	...
	while (EvaluatePerception("Good_Turbo_Attack_Location_Opportunity", PlayerObject, AITarget) > 0) do
		...
		if TestValid(enemy) then -- FIX and (MainForce.Get_Distance(enemy) < 1000) then
			BlockOnCommand(MainForce.Attack_Target(enemy))	--TODO: add max duration parameter to BlockOnCommand?
		else
			break
		end
	end
