-- $Id: //depot/Projects/StarWars/Run/Data/Scripts/AI/SpaceMode/MoveToLocationRush.lua#13 $
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
...
--/////////////////////////////////////////////////////////////////////////////////////////////////
--
--              $File: //depot/Projects/StarWars/Run/Data/Scripts/AI/SpaceMode/MoveToLocationRush.lua $
--
        ...
        if (EvaluatePerception("Is_Build_Pad", PlayerObject, Target) == 1) then
            ...
            if (structure == nil) or
				(TestValid(structure) and PlayerObject.Get_Faction_Name() ~= structure.Get_Owner().Get_Faction_Name()) then
					...
					if EvaluatePerception("Is_Refinery_Pad_Space", PlayerObject, Target) == 1 and
								EvaluatePerception("Number_Resource_Structures_Space", PlayerObject) == 0 then
