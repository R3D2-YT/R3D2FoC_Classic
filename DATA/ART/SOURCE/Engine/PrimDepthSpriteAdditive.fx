...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
//          $File: //depot/Projects/StarWars_Steam/FOC/Art/Shaders/Engine/PrimDepthSpriteAdditive.fx $
//          $Author: Brian_Hayes $
...
PS_OUTPUT_PS20 ps20_depth_sprite(VS_OUTPUT_PS20 In)
{
	...
	Out.Color = texel*In.Diff;	// Additive mode, multiply add vertex color and texture color
...
pixelshader ps14_depth_sprite_bin = asm
{
	...
	mul r0,r0,v0;	// Additive Mode: multiply vertex color and texture color
};
