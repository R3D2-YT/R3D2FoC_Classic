...
///////////////////////////////////////////////////////////////////////////////////////////////////
//
//          $File: //depot/Projects/StarWars_Steam/FOC/Art/Shaders/Engine/PrimDepthSpriteModulate.fx $
//          $Author: Brian_Hayes $
...
PS_OUTPUT_PS20 ps20_depth_sprite(VS_OUTPUT_PS20 In)
{
	...
	Out.Color = texel+In.Diff;	// modulate mode, add vertex color to texture color
...
pixelshader ps14_depth_sprite_bin = asm
{
	...
	add r0,r0,v0;	// Modulate Mode: add vertex color to texture color
};
